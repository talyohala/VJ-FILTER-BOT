...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7663483746').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-4729910639').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-4608019635')  # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-4667478009').split()]  # For Multiple Id Use One Space Between Each.

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tboxmove:HkhLBoLvv03Ozvht@cluster0.5yuuw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "tboxmovietv")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'tboxtv')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+wXRmwOKVh8Q2NDM0')
CHNL_LNK = environ.get('CHNL_LNK', https://t.me/+G-eK-ykyKDNmYmM0')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscussion')  # Support Chat Link Without https://t.me/+ZXWmeyJV8ttlNTRk
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/+n8aQm-p7OH03YjE8')
...
# Don't Remove Credit @VJ_Botz # Subscribe YouTube Channel For Amazing Bot @Tech_VJ # Ask Doubt on telegram @KingVJ01
