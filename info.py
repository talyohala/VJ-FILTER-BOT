...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002457797957').split()]  # For Multiple Id Use One Space Between Each.
...
mongodb+srv://tboxmove:HkhLBoLvv03Ozvht@cluster0.5yuuw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
